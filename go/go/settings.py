...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [('redis://:p7cbcd68ab0e3cfa486e68c4703bc25acae03e030a92ef3182ae267dc1ee4461a@ec2-72-44-37-44.compute-1.amazonaws.com:24569')],
        },
    },
}
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(Path(BASE_DIR).parent, 'static') # get parent of current directory
